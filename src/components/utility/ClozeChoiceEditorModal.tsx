            ...
            <div className="bg-background border rounded-xl shadow-2xl w-[90vw] max-w-md max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b bg-muted/30">
                    <h2 className="text-lg font-semibold flex items-center gap-2">
                        ...
                        {editingClozeChoice?.isNew ? 'Add Cloze Choice' : 'Edit Cloze Choice'}
                    </h2>
                    <button
                ...
                <div className="flex-1 overflow-auto p-4 space-y-4">
                    ...
                    <VariableNamePicker
                        value={varName}
                        onChange={setVarName}
                        helperText="Store the student's selection in a global variable"
                        customPlaceholder="e.g., shapeAnswer"
                    />
                ...
                <div className="flex items-center justify-end gap-2 px-4 py-3 border-t bg-muted/30">
                    ...
                    >
                        {editingClozeChoice?.isNew ? 'Add Component' : 'Apply Changes'}
                    </button>
                </div>
            </div>
        </div>
